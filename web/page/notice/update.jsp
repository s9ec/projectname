...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${requestScope.facilityAll}" var="dept" varStatus="stat">
            <tr>
                <td><input type="text" name="news_id" value="${dept.news_id}" readonly></td>
                <td><input type="text"  name="news_content" value="${dept.news_content}"></td>
                <td>
                    <select name="month" id="month">
                        <option value="${dept.month}">${dept.month}月</option>
                ...
                <td>
                    <select name="day" id="day">
                        <option value="${dept.day}">${dept.day}日</option>
