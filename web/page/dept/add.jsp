    ...
    <table class="layui-table">
        ...
        <tbody>
            <tr>
                ...
                <td><input type="text" name="facility_id" ></td>
                <td><input type="text" name="facility_name"></td>
                <td><input type="text" name="facility_business"></td>
                <td><input type="text" name="phone"></td>
                <td><input type="text" name="duty_people"></td>
                <td><input type="text" name="control_people"></td>
